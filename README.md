...
## Migration of researchers measures at subnational level and year

If you are interested in downloading only the migration measures calculated for researchers per subnational region and year, use the CSV file named "migr_19982017.csv" under the `results` folder.
